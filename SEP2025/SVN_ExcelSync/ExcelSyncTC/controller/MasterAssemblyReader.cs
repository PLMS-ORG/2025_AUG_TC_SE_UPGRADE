...
namespace ExcelSyncTC.controller
{
    class MasterAssemblyReader
    {
        ...
        public static List<String> ExcludedcomponentList = new List<String>();
                                ...
                                if (componentList.Contains(fileName) == false)
                                {
                                    if (Status != null && Status.Equals("") == false)
                                    {
                                        ...
                                        else if (Status.Equals("EXCLUDED", StringComparison.OrdinalIgnoreCase) == true)
                                        {
                                            ...
                                            if (ExcludedcomponentList.Contains(fileName) == false)
                                            {
                                                ExcludedcomponentList.Add(fileName);
                                            }
                                        }
