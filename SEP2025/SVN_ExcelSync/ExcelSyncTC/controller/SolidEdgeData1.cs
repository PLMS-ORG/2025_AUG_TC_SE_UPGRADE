                ...
                switch (objectType)
                {
                    case SolidEdgeFramework.ObjectType.igDimension:
                        ...
                        if (dimension != null)
                        {
                            ...
                            try
                            {
                                ...
                                //Utlity.Log("dimensionDName: " + displayName1 + " dimensionSName: " + dimension.SystemName + " dimensionType: " + dimensionType + " DimensionValue: " + dimensionValue + " DimensionValue1: " + dimensionValue1, logFilePath);
                                Variable varr = new Variable();                                
                                varr.name = dimension.DisplayName;                                
                                //varr.value = dimensionValue1;                                
                                varr.rangeLow = "";
                    ...
                    case SolidEdgeFramework.ObjectType.igVariable:
                        ...
                        if (variable != null)
                        {
                            ...
                            //Utlity.Log("VariableDName: " + displayName + " VariableSName: " + variable.SystemName + " variableType: " + SolidEdgeUOM.getType(variable, logFilePath) + " variableValue1: " + value + " variableValue2: " + value1, logFilePath);
...
public static void copyLinkedDocumentsToPublishedFolder2(String folderToPublish, String assemblyFileName, String logFilePath,bool copyExcelTemplate)
    ...
    public static void SearchAndcollectdrafts(String assemblyFileName, String destinationtoCopy,String draftSearchDir, String logFilePath)
    {
        ...
        //foreach (String fullName in assemblyStructureList)
        //{
        //    searchDrafts2(app, fullName, draftSearchDir, destinationtoCopy, logFilePath);
    ...
    private static void traverseToCollectLinkDocuments(SolidEdge.RevisionManager.Interop.Document linkDocument, string logFilePath)
    {
        ...
        private static void searchDrafts2(RevisionManager.Application app, String fileName, String searchDraftDirectory, String draftDestinationDirectory, String logFilePath)
        {
            if (app == null)
            {
                Utlity.Log("No Revision Manager Application : " + fileName, logFilePath);
