...
namespace Teamcenter.ClientX
{
    ...
    public class Session
    {
        ...
        public User login(String user, String password,String group,String role,String discriminator,String logFilePath)
        {
            ...
            {
                Utlity.Log("Unable to Login: " + "Session Service is NULL", logFilePath);
                return null;
            }
            ...
            try
            {
               ...
               LoginResponse resp = sessionService.Login(credentials[0], credentials[1],
                ...
                {
                    Utlity.Log("Exception while Logging into Teamcenter server", logFilePath);
                    return null;
                }
                return resp.User;
            }
            catch (InvalidCredentialsException e)
            {
               // credentials = credentialManager.GetCredentials(e);
                Utlity.Log("Unable to Login: " + e.Message, logFilePath);
            ...
            {
                Utlity.Log("Unable to Login: " + ex.Message, logFilePath);
                Utlity.Log("Unable to Login: " + ex.StackTrace, logFilePath);
            }
            return null;
