...
{
    [ComVisible(true)]
    //[Guid("BF1C1BB8-75EE-444A-8DCE-0F1521D0764B")] // Must be unique! - SE Stand Alone
    [Guid("8c1101ff-dd02-41a1-9df0-04a124f4c26c")]
    [ProgId("SolidEdgeCommunity.Samples.DemoAddInTC")] // Must be unique!
    public class DemoAddInTC :
        ...
        SolidEdgeFramework.ISEShortCutMenuEvents // Solid Edge Shortcut Menu Events
    {
        ...
        public override void OnConnection(SolidEdgeFramework.Application application, SolidEdgeFramework.SeConnectMode ConnectMode, SolidEdgeFramework.AddIn AddInInstance)
        {
            ...
            AddInEx.GuiVersion = 5;  //4- last used for admin+designer 5 - last used for designer
        ...
        public void OnCommand(int theCommandID)
        {
        ...
        {
            MessageBox.Show("BeforeCPDdisplay");
        }
        ...
        {
            MessageBox.Show("SEEC_IsPreCPDEventSupported"); 
            throw new NotImplementedException();
        }
        ...
        static void OnRegister(Type t)
        {
            ...
            //    settings.Titles.Add(englishCulture, "SolidEdgeCommunity.Samples.DemoAddInTC");
