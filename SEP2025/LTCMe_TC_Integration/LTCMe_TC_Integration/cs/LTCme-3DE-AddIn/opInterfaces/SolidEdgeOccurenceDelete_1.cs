...
namespace DemoAddInTC.opInterfaces
{
    class SolidEdgeOccurenceDelete_1 : IsolatedTaskProxy
    {
        ...
        public void SolidEdgeOccurrenceDeleteFromExcel(String assemblyFileName, String logFilePath)
        {
            ...
            //List<String> MasterAssemblyList = SyncTEDialog.componentList;
            ...
            List<String> ExcludecomponentList = SyncTEDialog.ExcludecomponentList;

            if (ExcludecomponentList == null || ExcludecomponentList.Count == 0)
            {
                Utlity.Log("SolidEdgeOccurrenceDeleteFromExcel: " + "ComponentsToDelete is Empty", logFilePath);
                return;
            }

            List<String> ComponentsToDelete = (List<String>)ExcludecomponentList;
