...
namespace DemoAddInTC
{
    public partial class MyCustomDialog : Form
    {
        ...
        {            
            ...
            foreach (DataRow row in ds.Rows)
            {
                ...
                //varr.AddVarToTemplate = getBoolValue(row, "AddVarToTemplate", logFilePath);
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {                
                ExcelInterface.SaveToXL(outputXLfileName, variablesList,null, logFilePath,"",null);                
       ...
       private void MyCustomDialog_FormClosed(object sender, FormClosedEventArgs e)
        {
   ...
   object sender, DataGridViewCellEventArgs e)
       ...
       private void populatePartNameToALLRows(string partName,String partSelectedOrNot)
       {
        ...
        /* --- Cut/Copy/Paste cells Functionality on the DataGridView--- */
